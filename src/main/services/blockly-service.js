...
// A função DEVE ser async para usar 'await'
async function executarCodigo(codigoJavaScript) {
    ...
    const blocklyFunctions = {
        ...
        led_pisca_n: async (comando, argsString) => blocklyFunctions.enviarComando('led_pisca_n', comando, argsString),
        pausa: async (comando, argsString) => blocklyFunctions.enviarComando('pausa', comando, argsString), // Inclui aguarde_segundos
        led_left: async (comando, argsString) => blocklyFunctions.enviarComando('led_left', comando, argsString),
        led_right: async (comando, argsString) => blocklyFunctions.enviarComando('led_right', comando, argsString),
        som_nota: async (comando, argsString) => blocklyFunctions.enviarComando('som_nota', comando, argsString),
        motor_esquerdo_frente: async (comando, argsString) => blocklyFunctions.enviarComando('motor_esquerdo_frente', comando, argsString),
        motor_direito_frente: async (comando, argsString) => blocklyFunctions.enviarComando('motor_direito_frente', comando, argsString),
        motor_esquerdo_tras: async (comando, argsString) => blocklyFunctions.enviarComando('motor_esquerdo_tras', comando, argsString),
        motor_direito_tras: async (comando, argsString) => blocklyFunctions.enviarComando('motor_direito_tras', comando, argsString),
        set_pin_mode: async (comando, argsString) => blocklyFunctions.enviarComando('set_pin_mode', comando, argsString),
        digital_write: async (comando, argsString) => blocklyFunctions.enviarComando('digital_write', comando, argsString),
        definir_pino_digital: async (comando, argsString) => blocklyFunctions.enviarComando('definir_pino_digital', comando, argsString),
        analog_write: async (comando, argsString) => blocklyFunctions.enviarComando('analog_write', comando, argsString),
        ler_ultrassom: async (comando, argsString) => blocklyFunctions.enviarComando('ler_ultrassom', comando, argsString),
        servo: async (comando, argsString) => blocklyFunctions.enviarComando('servo', comando, argsString),      
        servo360: async (comando, argsString) => blocklyFunctions.enviarComando('servo360', comando, argsString),
        mover_frente: async (comando, argsString) => blocklyFunctions.enviarComando('mover_frente', comando, argsString),
    ...
    try {
        ...
        logs.push(`[ERRO FATAL] Erro durante a execução do código JavaScript: ${err.message}`);
        return { status: false, mensagem: `Erro de execução: ${err.message}`, logs };
    }
    
    logs.push(`[SUCESSO] Todos os comandos do script JavaScript (incluindo laços de repetição) foram adicionados à fila de execução serial com sucesso.`);
